    ...
    <div style={{ minHeight: "100vh", paddingBottom: "60px" }}>
      ...
      <header style={{
        ...
        <div className="container" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div>
            <h1 style={{ fontSize: "24px", fontWeight: "700", marginBottom: "4px" }}>Sleep Debt</h1>
            <p style={{ fontSize: "14px", color: "var(--text-secondary)" }}>수면 부채 분석 서비스</p>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
            ...
            <div className="card" style={{ marginBottom: "24px" }}>
              ...
              <div style={{ display: "grid", gap: "20px" }}>
                <div>
                  <label style={{ fontSize: "14px", fontWeight: "500", marginBottom: "10px", display: "block" }}>🎯 목표 수면 시간</label>
                  <input
                    type="number"
                    min="4"
                    max="12"
                ...
                <div>
                  <label style={{ fontSize: "14px", fontWeight: "500", marginBottom: "10px", display: "block" }}>😴 실제 수면 시간</label>
                  <input
                    type="number"
                    min="0"
                    max="16"
                ...
                <div>
                  <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "10px" }}>
                    <label style={{ fontSize: "14px", fontWeight: "500" }}>☕ 카페인 섭취</label>
                ...
                <div>
                  <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "10px" }}>
                    <label style={{ fontSize: "14px", fontWeight: "500" }}>💪 현재 피로도</label>
